...
public class Globals {
    ...
    public static void showLoadingDialog(Activity activity) {
        if (!activity.getComponentName().getClassName().equals("com.videocall.livecelebrity.prankcall.splash.SplashScreenActivity")) { // Change this classpath according to your SplashScreen Activity
