...
public final class MediumNativeAdBinding implements ViewBinding {
  @NonNull
  ...
  private MediumNativeAdBinding(@NonNull NativeAdView rootView, @NonNull TextView adAdvertiser,
  ...
  @NonNull
  public static MediumNativeAdBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MediumNativeAdBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.medium_native_ad, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MediumNativeAdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MediumNativeAdBinding((NativeAdView) rootView, adAdvertiser, adAppIcon, adBody,
